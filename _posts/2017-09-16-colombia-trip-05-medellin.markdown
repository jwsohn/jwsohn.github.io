...
잠깐 메데진 전철 노선을 보십시다. 여기서 A와 B 공원을 잇는 노선이 케이블카로
운영됩니다. 노선 길이도 길고 경치도 좋습니다. [rewrite] 메데진의 분지 지형을
높은 곳에서 한눈에 바라볼 수도 있구요. 
...
개인적으로 Botero의 작품이 뭐랄까 예술적인 감흥까지는 와 닿지는 않는 것
같습니다. 제 경우는 오히려 칸딘스키(Kandinsky)나 파울 클레(Paul Klee)의 따뜻한
추상화들에 쉽게 공감하는 편이라서 변환을 통한 비교 보다는 직접적인
심상(心想)의 자극에 익숙한 것 같습니다. 하지만 앤디 워홀의 현대 사회의 반영(reflection)의
관점에서 접근해본다면 Botero 역시 다채로운 상상력을 펼칠 수 있는
가능성(capacity)이 높다고 할 수 있겠습니다. 그러고 보니 시간나면 앤디 워홀의
수많은 복제 작품을 한번 봐야 할 것 같네요. 
